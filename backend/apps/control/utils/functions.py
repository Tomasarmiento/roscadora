...
def get_front_states():
    data = {
        ...
        'lineal_flags': ws_vars.MicroState.axis_flags[ctrl_vars.AXIS_IDS['avance']],
        'cabezal_flags': ws_vars.MicroState.axis_flags[ctrl_vars.AXIS_IDS['carga']],
        'husillo_flags': ws_vars.MicroState.axis_flags[ctrl_vars.AXIS_IDS['giro']],
    }
    return data
